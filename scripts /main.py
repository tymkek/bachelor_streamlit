...
class SurveySite:
    def __init__ (self):
        ...
        # ]
        with open('../files/books_questions.json', 'r') as file:
            self.q_books = json.load(file)
        with open('../files/sigma_questions.json', 'r') as file:
            self.q_sigma = json.load(file)
        with open('../files/books.txt', 'r') as file:
            self.t_books = file.read()
        with open('../files/sigma.txt', 'r') as file:
    ...
    def home_page(self):
        with st.container():
            ...
            st.write("In the last stage, 5 question will be generated to chosen text, answer them as best as you can")
